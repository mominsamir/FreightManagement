...
export interface IAuthenticationClient {
    authenticate(model: ConfirmUserIdentify): Observable<FileResponse>;
...
export class AuthenticationClient implements IAuthenticationClient {
    ...
    tester(): Observable<string> {
        let url_ = this.baseUrl + "/api/Authentication/tester";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTester(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTester(<any>response_);
                } catch (e) {
    ...
    protected processTester(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    employee(): Observable<string> {
        let url_ = this.baseUrl + "/api/Authentication/employee";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processEmployee(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    manager(): Observable<string> {
        let url_ = this.baseUrl + "/api/Authentication/manager";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processManager(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processManager(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ConfirmUserIdentify implements IConfirmUserIdentify {
    email?: string | undefined;
    password?: string | undefined;

    constructor(data?: IConfirmUserIdentify) {
        if (data) {
    ...
    static fromJS(data: any): ConfirmUserIdentify {
        data = typeof data === 'object' ? data : {};
        let result = new ConfirmUserIdentify();
        result.init(data);
        return result;
    }
...
export interface IConfirmUserIdentify {
    email?: string | undefined;
    password?: string | undefined;
}
