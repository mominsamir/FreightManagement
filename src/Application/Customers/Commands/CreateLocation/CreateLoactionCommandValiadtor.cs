...
{
    public class CreateLoactionCommandValiadtor : AbstractValidator<CreateLocationCommand>
    {
        private readonly IApplicationDbContext _contex;

        public CreateLoactionCommandValiadtor(IApplicationDbContext contex)
        {
            _contex = contex;
            ...
            RuleFor(v => v.Name)
                 ...
                 .MustAsync(BeUniqueName).WithMessage("Location name must not exceed 200 characters.");
        ...
        {
            return await _contex.Locations.AllAsync(l => l.Name == name, cancellationToken);
        }
    }
}
