...
const DateTimeFilter: React.FC<DataTableFilterOption> = props => {
        ...
        <div style={{display:'flex'}}>
            ...
            {opterator === 'BETWEEN' &&  
                <Form.Item
                    ...
                    <RangePicker showTime={true} format={'MM-DD-YYYY HH:mm:ss'}></RangePicker> 
                </Form.Item>            
            }
            {opterator !== 'BETWEEN' &&  
                <Form.Item
                    style={{width:'100%'}}             
                    name={[props.fieldKey!!, "value"]} fieldKey={[props.fieldKey!!, "value"]} >
                    <DatePicker showTime={true} placeholder={props.title} format={'MM-DD-YYYY HH:mm:ss'}></DatePicker> 
                </Form.Item>            
            }
        </div>
    )
